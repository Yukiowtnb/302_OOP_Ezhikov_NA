...
class StudentsListTest extends TestCase
{
    ...
    public static function setUpBeforeClass(): void
    {
        ...
        self::$student1->setLastname('Priniaev')->setName('Vladislav')->setFaculty('FI')->setCourse(2)->setGroup(205);
        self::$student2 = new Student();
        self::$student2->setLastname('Karakulev')->setName('Sergey')->setFaculty('TI')->setCourse(2)->setGroup(207);
        self::$student3 = new Student();
        self::$student3->setLastname('Pyataeva')->setName('Arina')->setFaculty('FI')->setCourse(2)->setGroup(205);
    }
