import createVector3 from '../src/index.js';
...
describe('createVector', () => {
	...
	beforeAll(() => {
		v0 = new createVector3(0, 0, 0);
		v1 = new createVector3(-3, 6, -6);
		v2 = new createVector3(4, -12, 3);
	});
	...
	test('getLength()', () => {
		...
		expect(new createVector3(0, 1, 0).getLength()).toBe(1);
	});
